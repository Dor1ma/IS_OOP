...
public class TestValuesStorage : IStorage
{
    ...
    private readonly string _intelBiosName = "I am Intel bios";
    private readonly ICollection<Processor> _intelBiosSupportableProcessors = new List<Processor>();
    ...
    public TestValuesStorage()
    {
        ...
        _amdBiosSupportableProcessors.Add(
            new Am4Processor(
                _firstProcessorName,
                _firstProcessorCoreFrequency,
                _firstProcessorCoreCount,
        ...
        Bios amdBios = new BiosTypeOne(_amdBiosName, _biosVersion, _amdBiosSupportableProcessors);
        ...
        _intelBiosSupportableProcessors.Add(
            new Lga1700Processor(
                initSocketName,
                _specialInitValue,
                _specialInitValue,
                initSocketGpu,
        ...
        Bios intelBios = new BiosTypeOne(_intelBiosName, _biosVersion, _intelBiosSupportableProcessors);
        _components.Add(new AtxMotherBoard(
