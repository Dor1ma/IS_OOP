...
public class AtxMotherBoard : MotherBoard
{
    ...
    public AtxMotherBoard(string name, Processor processorSocket, IChipset chipset, IRamType supportableDdrType)
    ...
    {
        return new AtxMotherBoard((string)Name.Clone(), ProcessorSocket, Chipset, SupportableDdrType);
    }
}