...
public class AtxMotherBoardFactory : MotherBoardFactory
{
    public AtxMotherBoardFactory(string name, Processor processorSocket, IChipset chipset, IRamType supportableDdrType, Bios bios)
